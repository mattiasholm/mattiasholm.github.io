...
# #{{DIVE_NUMBER}}
<iframe src="https://www.google.com/maps?q={{LATITUDE}},{{LONGITUDE}}&z=15&output=embed" height="200" width="100%" style={{ borderRadius: '20px', marginBottom: '1rem', maxWidth: '400px' }}/>
